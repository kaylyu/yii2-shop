            ...
            <div class="col-xs-12 col-md-5 no-margin">
                <div class="product-item-holder size-big single-product-gallery small-gallery">
                    ...
                    <div id="best-seller-single-product-slider" class="single-product-slider owl-carousel">
                        ...
                        ?>
                            <div class="single-product-gallery-item" id="slide<?php echo ($idx++)+2; ?>">
                                <a data-rel="prettyphoto" href="<?php echo $pic ?>">
                                    <img alt="" src="<?php echo $pic ?>-coverbig" data-echo="<?php echo $pic ?>-coverbig" />
                                </a>
                            </div><!-- /.single-product-gallery-item -->
                        <?php } ?>
                    ...
                    <div class="gallery-thumbs clearfix">
                        <ul>
                            ...
                            <?php
                                ...
                                foreach ((array)json_decode($last->pics, true) as $key => $pic):
                            ?>
                                <li><a class="horizontal-thumb" data-target="#best-seller-single-product-slider" data-slide="<?php echo $idx+1; ?>" href="#slide<?php echo $idx+2; ?>"><img alt="" src="<?php echo $pic ?>-picsmall" data-echo="<?php echo $pic ?>-picsmall" /></a></li>
                            <?php
                                $idx++;
                                endforeach;
                            ?>
