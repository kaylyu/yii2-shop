        ...
        <?=GridView::widget([
                ...
                'columns' =>[
                    ...
                    [
                        ...
                        'format'=>'text',
                        'filter' => Html::activeTextInput($searchModel, 'description', ['class'=>'', 'placeholder'=>'请输入名称过滤'])
                    ],
                    [
                        'attribute'=>'name',
                        'format'=>'text',
                        'filter'=>Html::activeTextInput($searchModel, 'name', ['class'=>'', 'placeholder'=>'请输入标识过滤'])
                    ],
                    [
                        'attribute'=>'rule_name',
                        'format'=>'text',
                        'filter'=>Html::activeTextInput($searchModel, 'rule_name', ['class'=>'', 'placeholder'=>'请输入标识过滤'])
                    ],
                    [
